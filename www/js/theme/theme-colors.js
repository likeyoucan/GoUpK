...
/** @typedef {import("../types/managers-contracts.js").ThemeManagerContract} ThemeManagerContract */

const modeSelect = createThemeModeSelectController();

/** @type {ThemeManagerContract} */
export const themeManager = {
   ...
   * @param {{recordHistory?: boolean, skipProCheck?: boolean}} [options]
   */
