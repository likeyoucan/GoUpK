...
import { clamp, snap2, isCompactRing, isRowLayout, getTopHalfEl } from "./geometry.js?v=VERSION";
...
export function applyDisplayScale(displayEl, ringPx, renderedRingPx) {
    ...
    const rowLayout = isRowLayout(getTopHalfEl(displayEl.closest(".timer-circle-wrap")));
