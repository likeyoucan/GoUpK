...
export const translations = {
  en: {
    ...
    completed: "Completed",
    stopped: "Stopped",
    timer_behavior: "Timer Behavior",
    finish_stop: "Stop",
    finish_auto_repeat: "Auto Repeat",
    finish_switch_rest: "Switch To Rest",
    focus_mode: "Focus Mode",
    focus_mode_auto: "Auto Focus On Start",
  ...
  ru: {
    ...
    backup_import_json: "Import JSON",
    backup_import_mode: "Import mode",
    backup_mode_merge: "Merge",
    backup_mode_replace: "Replace",
    backup_apply: "Apply Import",
    backup_invalid_json: "Invalid JSON format",
    backup_select_file: "Select backup JSON file first",
    backup_applied_reload: "Import applied. Reloading...",
    ...
    timer_presets: "Пресеты таймера",
    history: "История",
    run_again: "Повторить",
    completed: "Завершено",
    stopped: "Остановлено",
    timer_behavior: "Поведение таймера",
    finish_stop: "Остановить",
    finish_auto_repeat: "Автоповтор",
    finish_switch_rest: "Перейти в отдых",
    focus_mode: "Режим концентрации",
    focus_mode_auto: "Авто-фокус при старте",
    seconds_value: "Секунды",
