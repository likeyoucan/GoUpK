...
export const themeManager = {
  ...
  _showDeleteButton(targetWrapper, type) {
    ...
    btn.className =
      "color-delete-btn w-8 h-8 flex-shrink-0 flex items-center justify-center rounded-full bg-red-500 text-white shadow-lg focus:outline-none custom-focus active:scale-90 transition-transform";
  ...
  _createAddButton(type) {
    ...
    btn.className =
      "color-add-btn w-8 h-8 flex items-center justify-center rounded-full bg-black/5 dark:bg-white/5 app-text-sec hover:primary-text transition-colors custom-focus active:scale-90";
